...
public interface DtsOrderGoodsMapper {
    ...
    List<DtsOrderGoods> selectDtsOrderGoodsList(DtsOrderGoods dtsOrderGoods);

    long countByGid(DtsOrderGoods example);

    int updateOrderGoodsById(DtsOrderGoods record);

    int addOrderGoods(DtsOrderGoods record);

    long countByDtsOrderGoods(DtsOrderGoods dtsOrderGoods);

    DtsOrderGoods selectDtsOrderGoodsById(Integer id);
