...
public class AdminOrderController {
	...
	@GetMapping("/list")
	public Object list(Integer userId, String orderSn, String payStartDate, String payEndDate,@RequestParam(required = false) List<Short> orderStatusArray,
		...
		return adminOrderService.list(userId, orderSn, payStartDate, payEndDate,orderStatusArray, page, limit, sort, order);
	}
